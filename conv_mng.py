...
class TextBasedConversationManager:
    ...
    def start_conversation(self):
        ...
        print("Hello! I'm your AI loan assistant. Let's start your loan application.")
        ...
        while question_count < self.max_questions:
            ...
            user_response = self.get_user_input(next_question)
            ...
            if user_response.lower() in ["exit", "quit", "stop"]:
                print("Thank you for using our service. I'll generate a report with the information provided so far.")
            ...
            if user_response.lower() in ["generate", "report", "show report", "generate report"]:
                print("Generating your loan eligibility report now.")
                self.display_report()
                continue
            ...
            if response_data.get("needs_clarification"):
                ...
                clarification_response = self.get_user_input(clarification_question)
...
if __name__ == "__main__":
    conversation_manager = TextBasedConversationManager()
