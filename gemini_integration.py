...
class GeminiAI:
    ...
    Gathering key loan and personal details in a conversational manner (max 5 important questions).
    Verifying identity and financial details (assume documents are verified).
